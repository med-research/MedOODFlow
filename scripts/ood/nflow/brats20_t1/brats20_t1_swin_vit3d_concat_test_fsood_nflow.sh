#!/bin/bash
# sh scripts/ood/nflow/brats20_t1/brats20_t1_swin_vit3d_concat_test_fsood_nflow.sh
...
python main.py \
    ...
    --network.backbone.encoder.checkpoint "./results/brats20_t1_swin_vit3d_med3d_e200_lr0.0001_default/s${SEED}/best.ckpt" \
    --seed ${SEED} \
    --mark ${MARK}
