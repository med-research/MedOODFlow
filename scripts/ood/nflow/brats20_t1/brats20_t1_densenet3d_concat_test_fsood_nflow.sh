#!/bin/bash
# sh scripts/ood/nflow/brats20_t1/brats20_t1_densenet3d_concat_test_fsood_nflow.sh
...
python main.py \
    ...
    --network.backbone.encoder.checkpoint "./results/brats20_t1_densenet3d_121_med3d_e100_lr0.0001_default/s${SEED}/best.ckpt" \
    --seed ${SEED} \
    --mark ${MARK}
