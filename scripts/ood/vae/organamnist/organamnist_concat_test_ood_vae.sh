#!/bin/bash
# sh scripts/ood/vae/organamnist/organamnist_concat_test_ood_vae.sh
...
python main.py \
    ...
    --network.checkpoint "./results/organamnist_vae_vae_e100_lr0.0001_${MARK}/s${SEED}/best_vae.ckpt" None \
    --network.backbone.pretrained False \
    --seed ${SEED} \
    --mark ${MARK}
