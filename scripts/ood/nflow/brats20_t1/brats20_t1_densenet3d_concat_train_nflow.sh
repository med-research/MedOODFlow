#!/bin/bash
# sh scripts/ood/nflow/brats20_t1/brats20_t1_densenet3d_concat_train_nflow.sh
...
python main.py \
    ...
    configs/networks/densenet3d_121_feat_concat.yml \
    ...
    --network.encoder.checkpoint "./results/brats20_t1_densenet3d_121_med3d_e100_lr0.0001_default/s${SEED}/best.ckpt" \
    --seed ${SEED} \
    --mark ${MARK}
...
python main.py \
    --config configs/datasets/medood/brats20_t1.yml \
    configs/networks/nflow_densenet3d_121_feat_concat.yml \
